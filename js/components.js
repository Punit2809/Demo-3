...
<div class="topbar d-none d-lg-block">
  <div class="container">
    <div class="d-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center gap-4 topbar-info">
        <a href="mailto:info@ascendstaffing.com" class="topbar-link">
          ...
          info@ascendstaffing.com
        </a>
        <a href="tel:+15552345678" class="topbar-link">
          <svg class="tb-icon" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
          +1 (555) 234-5678
        </a>
        <span class="topbar-link">
          <svg class="tb-icon" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
          500 Commerce Street, Suite 1200, New York, NY
        </span>
      </div>
      <div class="d-flex align-items-center gap-3">
        ...
        <a href="#" class="topbar-social" aria-label="X / Twitter">
    ...
    <a class="navbar-brand" href="index.html">
      <span class="brand-mark">
        <svg viewBox="0 0 40 40" width="34" height="34" fill="none" aria-hidden="true">
          <rect width="40" height="40" rx="9" fill="#2456c8"/>
          <path d="M11 27 20 12l9 15" stroke="#ffffff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <path d="M14 22h12" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/>
        </svg>
      </span>
      <span class="brand-text">Ascend <span class="brand-sub">Staffing</span></span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        ...
        <li class="nav-item nav-cta">
          <a class="btn btn-royal" href="candidates.html#submit-resume">Submit Resume</a>
        </li>
      </ul>
    </div>
  </div>
...
<footer class="site-footer">
      ...
      <div class="row g-4">
        <div class="col-lg-4 col-md-6">
          ...
          <p class="footer-about">
            Ascend is a professional IT staffing and recruitment firm connecting skilled technology
            professionals with the businesses that need them — through honest, reliable and
            people-first hiring solutions.
          </p>
          <div class="footer-social">
            <a href="#" aria-label="LinkedIn"><svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.36V9h3.41v1.56h.05c.47-.9 1.63-1.85 3.36-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12zM7.12 20.45H3.56V9h3.56v11.45z"/></svg></a>
            <a href="#" aria-label="X"><svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M18.9 2H22l-6.77 7.74L23.2 22h-6.23l-4.88-6.38L6.5 22H3.4l7.24-8.28L2.6 2h6.39l4.41 5.83L18.9 2zm-1.09 18h1.72L7.86 3.9H6.02L17.81 20z"/></svg></a>
            <a href="#" aria-label="Facebook"><svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M13.5 22v-8h2.7l.4-3.1h-3.1V8.9c0-.9.25-1.5 1.55-1.5h1.65V4.6c-.3-.04-1.3-.13-2.4-.13-2.4 0-4 1.45-4 4.13v2.3H7.6V14h2.7v8h3.2z"/></svg></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          ...
          <ul class="footer-links">
            ...
            <li><a href="services.html">Permanent Staffing</a></li>
            <li><a href="services.html">IT Staff Augmentation</a></li>
            <li><a href="services.html">Executive Recruitment</a></li>
            <li><a href="services.html">Remote Staffing</a></li>
            <li><a href="services.html">Project-Based Recruitment</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <ul class="footer-contact">
            ...
            <li>
              ...
              <a href="mailto:info@ascendstaffing.com">info@ascendstaffing.com</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="footer-bottom">
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
      <p class="mb-0">© <span id="year">2026</span> Ascend Staffing Solutions. All rights reserved.</p>
